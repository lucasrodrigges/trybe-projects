...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(console.log(createMenu())).toEqual(console.log(objetoRetornado));
    ...
    objetoRetornado.order('agua');
    objetoRetornado.order('agua');
    expect(objetoRetornado.consumption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi', 'agua', 'agua']);
    ...
    // ```
    expect(objetoRetornado.pay()).toBe('R$345,00, afinal tem comida japonesa no meio...');
